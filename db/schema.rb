...
ActiveRecord::Schema.define(version: 20151226050713) do
  ...
  add_index "follows", ["from_user_id", "to_user_id"], name: "index_follows_on_from_user_id_and_to_user_id", unique: true, using: :btree
